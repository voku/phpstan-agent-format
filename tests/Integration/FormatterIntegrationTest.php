...
final class FormatterIntegrationTest
{
    public static function run(): void
    {
        ...
        /** @var array{tool: string, summary: array{totalIssues: int}, clusters: list<array{affectedFiles: list<string>, representativeIssues: list<array{symbolContext: array{parameterName: ?string, expectedType: ?string, inferredType: ?string, typeOrigin: ?string}, secondaryLocations: list<array{file: string, line: int}>, contextTrace: array{hops: list<array{kind:string,summary: string}>}}>}>} $decoded */
